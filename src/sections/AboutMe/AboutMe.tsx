    ...
    <StyledInnerWrapper>
      ...
      <StyledText>
        <p>
          ...
          street photography, portrait photography and front-end technologies
          that I&apos;ve been learning for over a year.
          <br />
          I am familiar with semantic HTML5 and CSS. I know BEM methodology,
          JavaScript basics with ES6+ elements, ReactJS and GatsbyJS basics with
          Styled Components or CSS Modules. I can also use Git version control
